                ...
                {loading ? (
                    ...
                    data.map((product, index) => (
                        <Link
                            ...
                            className='w-full min-w-[300px] md:min-w-[350px] max-w-[300px] md:max-w-[350px] h-36 bg-white rounded-sm shadow flex'>
                            ...
                            <div className='p-4 grid'>
                                ...
                                <button
                                    className='text-sm bg-gray-600 hover:bg-red-700 text-white px-3 py-0.5 rounded-full'

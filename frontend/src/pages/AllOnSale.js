...
const AllOnSale = () => {
    ...
    const handleDelete = async (id) => {
        const fetchData = await fetch(`https://swp-final-backend.onrender.com/api/delete-sale-product/${id}`, {
            method: 'DELETE',
            credentials: 'include',
        });
    ...
    const fetchAllOnSaleProduct = async () => {
        const fetchData = await fetch('https://swp-final-backend.onrender.com/api/get-all-sale-products', {
            method: 'GET',
            credentials: 'include',
        });
